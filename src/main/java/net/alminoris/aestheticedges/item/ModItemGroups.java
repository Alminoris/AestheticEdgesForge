...
public class ModItemGroups
{
    ...
    public static final CreativeModeTab AEDGS_TAB = new CreativeModeTab(AestheticEdges.MOD_ID + ".aedgstab") {
        @Override
        public ItemStack makeIcon() {
            return new ItemStack(ModBlocks.CURBSTONES_OUTER.get("stone_bricks").get().asItem());
        }
